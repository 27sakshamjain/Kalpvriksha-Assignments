...
void insert_at_beginning(struct LinkedList *list, void *data, int size) {
...
int main() {
    ...
    int num = 10;
    insert_at_beginning(&list, &num, 1); 

    char str = 'H';
    insert_at_beginning(&list, &str, 2);

    double pi = 3.14;
    insert_at_beginning(&list, &pi, 3); 
